...
// Note: the idea here is to have every platform define their own setup.cpp file
// that implements a GLEnvironment subclass internally, then return it as a
// definition for GLEnvironment::Create
