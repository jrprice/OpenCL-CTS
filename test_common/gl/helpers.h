...
typedef cl_mem(CL_API_CALL *clCreateFromGLRenderbuffer_fn)(cl_context context,
                                                           cl_mem_flags flags,
                                                           GLuint renderbuffer,
                                                           cl_int *errcode_ret);
...
public:
    ...
    ~glBufferWrapper()
    {
        if (mBuffer != 0) glDeleteBuffers(1, &mBuffer);
    }

    glBufferWrapper &operator=(const GLuint &rhs)
    {
        mBuffer = rhs;
        return *this;
    }
...
public:
    ...
    glTextureWrapper &operator=(const GLuint &rhs)
    {
        mHandle = rhs;
        return *this;
    }
...
public:
    ...
    {
        if (mBuffer != 0) glDeleteRenderbuffersEXT(1, &mBuffer);
    }

    glRenderbufferWrapper &operator=(const GLuint &rhs)
    {
        mBuffer = rhs;
        return *this;
    }
...
public:
    ...
    {
        if (mBuffer != 0) glDeleteFramebuffersEXT(1, &mBuffer);
    }

    glFramebufferWrapper &operator=(const GLuint &rhs)
    {
        mBuffer = rhs;
        return *this;
    }
...
public:
    ...
    {
        if (mBuffer != 0) glDeleteVertexArrays(1, &mBuffer);
    }

    glVertexArraysWrapper &operator=(const GLuint &rhs)
    {
        mBuffer = rhs;
        return *this;
    }
...
public:
    ...
    glProgramWrapper &operator=(const GLuint &rhs)
    {
        mProgram = rhs;
        return *this;
    }
...
public:
    ...
    ~glShaderWrapper()
    {
        if (mShader != 0) glDeleteShader(mShader);
    }

    glShaderWrapper &operator=(const GLuint &rhs)
    {
        mShader = rhs;
        return *this;
    }
...
extern void *CreateGLTexture1DArray(size_t width, size_t length, GLenum target,
...
extern void *CreateGLTextureBuffer(size_t width, GLenum target, GLenum glFormat,
                                   GLenum internalFormat, GLenum glType,
                                   ExplicitType type, GLuint *outTex,
                                   GLuint *outBuf, int *outError,
                                   bool allocateMem, MTdata d);

extern void *CreateGLTexture1D(size_t width, GLenum target, GLenum glFormat,
                               GLenum internalFormat, GLenum glType,
                               ExplicitType type, GLuint *outTextureID,
                               int *outError, bool allocateMem, MTdata d);

extern void *CreateGLTexture2D(size_t width, size_t height, GLenum target,
                               GLenum glFormat, GLenum internalFormat,
                               GLenum glType, ExplicitType type,
                               GLuint *outTextureID, int *outError,
                               bool allocateMem, MTdata d);
...
extern void *CreateGLTexture3D(size_t width, size_t height, size_t depth,
                               ...
                               GLenum internalFormat, GLenum glType,
                               ExplicitType type, GLuint *outTextureID,
                               int *outError, MTdata d,
                               bool allocateMem = true);

#ifdef GL_VERSION_3_2
extern void *CreateGLTexture2DMultisample(
size_t width, size_t height, size_t samples, GLenum target, GLenum glFormat,
GLenum internalFormat, GLenum glType, ExplicitType type, GLuint *outTextureID,
int *outError, bool allocateMem, MTdata d, bool fixedSampleLocations);

extern void *CreateGLTexture2DArrayMultisample(
size_t width, size_t height, size_t length, size_t samples, GLenum target,
...
extern void *ReadGLTexture(GLenum glTarget, GLuint glTexture, GLuint glBuf,
                           GLint width, GLenum glFormat,
                           GLenum glInternalFormat, GLenum glType,
                           ExplicitType typeToReadAs, size_t outWidth,
                           size_t outHeight);

extern int CreateGLRenderbufferRaw(GLsizei width, GLsizei height, GLenum target,
                                   GLenum glFormat, GLenum internalFormat,
                                   GLenum glType, GLuint *outFramebuffer,
                                   GLuint *outRenderbuffer);

extern void *CreateGLRenderbuffer(GLsizei width, GLsizei height, GLenum target,
                                  GLenum glFormat, GLenum internalFormat,
                                  GLenum glType, ExplicitType type,
                                  GLuint *outFramebuffer,
                                  GLuint *outRenderbuffer, int *outError,
...
extern void DumpGLBuffer(GLenum type, size_t width, size_t height,
                         void *buffer);
