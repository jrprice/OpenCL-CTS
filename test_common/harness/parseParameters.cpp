...
void helpInfo()
{
    ...
    "Common options:\n"
    "        -h, --help                  This help\n"
    "        --compilation-mode <mode>   Specify a compilation mode.  Mode can "
    "be:\n"
    ...
    "        --compilation-cache-mode <cache-mode>  Specify a compilation "
    "caching mode:\n"
    "                                 compile-if-absent  Read from cache if "
    "already populated, or\n"
    "                                                    else perform offline "
    "compilation (default)\n"
    "                                 force-read        Force reading from the "
    "cache\n"
    "                                 overwrite         Disable reading from "
    "the cache\n"
    "                                 dump-cl-files     Dumps the .cl and "
    "build .options files used by the test suite\n"
    "        --compilation-cache-path <path>   Path for offline compiler "
    "output and CL source\n"
    "        --compilation-program <prog>      Program to use for offline "
    "compilation,\n"
    "                                          defaults "
    "to " DEFAULT_COMPILATION_PROGRAM "\n"
    "\n");
}
