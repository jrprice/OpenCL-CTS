...
int test_contractions_float_0(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(0);
}

int test_contractions_float_1(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(1);
}

int test_contractions_float_2(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(2);
}

int test_contractions_float_3(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(3);
}

int test_contractions_float_4(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(4);
}

int test_contractions_float_5(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(5);
}

int test_contractions_float_6(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(6);
}

int test_contractions_float_7(cl_device_id deviceID, cl_context context,
                              cl_command_queue queue, int num_elements)
{
    return RunTest(7);
}

int test_contractions_double_0(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(0);
}

int test_contractions_double_1(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(1);
}

int test_contractions_double_2(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(2);
}

int test_contractions_double_3(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(3);
}

int test_contractions_double_4(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(4);
}

int test_contractions_double_5(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(5);
}

int test_contractions_double_6(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
    return RunTest_Double(6);
}

int test_contractions_double_7(cl_device_id deviceID, cl_context context,
                               cl_command_queue queue, int num_elements)
{
...
test_definition test_list[] = {
    ADD_TEST(contractions_float_0),  ADD_TEST(contractions_float_1),
    ADD_TEST(contractions_float_2),  ADD_TEST(contractions_float_3),
    ADD_TEST(contractions_float_4),  ADD_TEST(contractions_float_5),
    ADD_TEST(contractions_float_6),  ADD_TEST(contractions_float_7),
    ADD_TEST(contractions_double_0), ADD_TEST(contractions_double_1),
    ADD_TEST(contractions_double_2), ADD_TEST(contractions_double_3),
    ADD_TEST(contractions_double_4), ADD_TEST(contractions_double_5),
    ADD_TEST(contractions_double_6), ADD_TEST(contractions_double_7),
};
...
int main(int argc, const char **argv)
{
    ...
    if (!error)
    {
        error = runTestHarnessWithCheck(gArgCount, gArgList, test_num,
    ...
    if (gQueue)
    {
        ...
        if (flush_error) log_error("clFinish failed: %d\n", flush_error);
    }
            ...
            while (arg[1] != '\0')
            {
                ...
                switch (*arg)
                {
                    ...
                    case 's':
                        arg++;
                        gSeed = atoi(arg);
                        while (arg[length_of_seed] >= '0'
                               && arg[length_of_seed] <= '9')
                            length_of_seed++;
                        gSeedSpecified = 1;
...
const char *sizeNames_double[] = { "double", "double2", "double4", "double8",
                                   "double16" };
...
test_status InitCL(cl_device_id device)
{
    ...
    if ((error = clGetDeviceInfo(device, CL_DEVICE_EXTENSIONS, 0, NULL,
                                 &extensions_size)))
    {
    ...
    if (extensions_size)
    {
        ...
        {
            vlog_error(
            "ERROR: Unable to allocate %ld bytes to hold extensions string\n",
            extensions_size);
            return TEST_FAIL;
        }

        if ((error = clGetDeviceInfo(device, CL_DEVICE_EXTENSIONS,
                                     extensions_size, extensions, NULL)))
        {
    ...
    if (0 == (CL_FP_INF_NAN & floatCapabilities)) gSkipNanInf = 1;

    // Embedded devices that flush to zero are allowed to have an undefined
    // sign.
    if (gIsEmbedded && gForceFTZ) gIgnoreZeroSign = 1;
    ...
    if (bufA == NULL || bufB == NULL || bufC == NULL || bufD == NULL
        || bufE == NULL)
    {
    ...
    {
        bufC_double =
        clCreateBuffer(gContext, CL_MEM_READ_WRITE, BUFFER_SIZE, NULL, NULL);
        bufD_double =
        clCreateBuffer(gContext, CL_MEM_READ_WRITE, BUFFER_SIZE, NULL, NULL);
        if (bufC_double == NULL || bufD_double == NULL)
        {
    ...
    const char *kernels[] = { "",
                              ...
                              "__kernel void kernel1( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel2( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel3( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel4( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel5( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel6( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel7( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
                              ...
                              "}\n"
                              "\n"
                              "__kernel void kernel8( __global ",
                              NULL,
                              " *out, const __global ",
                              NULL,
                              " *a, const __global ",
    ...
    for (i = 0; i < sizeof(sizeNames) / sizeof(sizeNames[0]); i++)
    {
        ...
        gProgram[i] =
        clCreateProgramWithSource(gContext, strCount, kernels, NULL, &error);
        if (NULL == gProgram[i])
        {
        ...
        if ((error = clBuildProgram(gProgram[i], 1, &device, NULL, NULL, NULL)))
        {
            ...
            clGetProgramBuildInfo(gProgram[i], device, CL_PROGRAM_BUILD_LOG,
    ...
    if (gHasDouble)
    {
             ...
             i++)
        {
            ...
            gProgram_double[i] = clCreateProgramWithSource(
            gContext, strCount, kernels, NULL, &error);
            ...
            if ((error = clBuildProgram(gProgram_double[i], 1, &device, NULL,
                                        NULL, NULL)))
            {
                vlog_error("clBuildProgramExecutable failed\n");
                char build_log[2048] = "";

                clGetProgramBuildInfo(gProgram_double[i], device,
                                      CL_PROGRAM_BUILD_LOG, sizeof(build_log),
                                      build_log, NULL);
                vlog_error("Log:\n%s\n", build_log);
                return TEST_FAIL;
            }
    ...
    if (0 == gSeedSpecified)
    {
        ...
        + 60
        * (t->tm_min
           + 60 * (t->tm_hour + 24 * (t->tm_yday + 365 * t->tm_year)));
    ...
    // Init bufA and bufB
    {
        ...
        if (NULL == buf1 || NULL == buf2 || NULL == buf3 || NULL == buf4
            || NULL == buf5 || NULL == buf6 || NULL == bufSkip)
        {
        ...
        if ((error = clEnqueueWriteBuffer(gQueue, bufA, CL_FALSE, 0,
                                          BUFFER_SIZE, buf1, 0, NULL, NULL)))
        {
        ...
        if ((error = clEnqueueWriteBuffer(gQueue, bufB, CL_FALSE, 0,
                                          BUFFER_SIZE, buf2, 0, NULL, NULL)))
        {
        ...
        void *ftzInfo = NULL;
        if (gForceFTZ) ftzInfo = FlushToZero();
        ...
        for (i = 0; i < BUFFER_SIZE / sizeof(float); i++)
        {
            ...
            f4[i] = -q * q2;
#endif
            // Skip test if the device doesn't support infinities and NaN AND
            // the result overflows or either input is an infinity of NaN
            bufSkip[i] =
            (gSkipNanInf
             && ((FE_OVERFLOW == (FE_OVERFLOW & fetestexcept(FE_OVERFLOW)))
                 || (fabsf(q) == FLT_MAX) || (q != q) || (fabsf(q2) == FLT_MAX)
                 || (q2 != q2)));
        }

        if (gForceFTZ) UnFlushToZero(ftzInfo);

        if (isRTZ) (void)set_round(oldRoundMode, kfloat);


        if ((error = clEnqueueWriteBuffer(gQueue, bufC, CL_FALSE, 0,
                                          BUFFER_SIZE, buf3, 0, NULL, NULL)))
        {
            vlog_error("Failure %d at clEnqueueWriteBuffer3\n", error);
            return TEST_FAIL;
        }
        if ((error = clEnqueueWriteBuffer(gQueue, bufD, CL_FALSE, 0,
                                          BUFFER_SIZE, buf4, 0, NULL, NULL)))
        {
        ...
        float *f5 = (float *)buf5;
        float nan_val = nanf("");
        for (i = 0; i < BUFFER_SIZE / sizeof(float); i++) f5[i] = nan_val;
        ...
        for (i = 0; i < BUFFER_SIZE / sizeof(float); i++)
        {
            for (j = 0; j < 8; j++)
            {
                ...
                {
#if defined(_MSC_VER) && (defined(_M_IX86) || defined(_M_X64))
                        // VS2005 might use x87 for straight add/sub, and we
                        // can't turn that off
                    case 0: correct[0][i] = sse_add(buf3[i], buf4[i]); break;
                    case 1: correct[1][i] = sse_sub(buf3[i], buf3[i]); break;
                    case 2: correct[2][i] = sse_add(buf4[i], buf3[i]); break;
                    case 3: correct[3][i] = sse_sub(buf3[i], buf3[i]); break;
                    case 4: correct[4][i] = -sse_add(buf3[i], buf4[i]); break;
                    case 5: correct[5][i] = -sse_sub(buf3[i], buf3[i]); break;
                    case 6: correct[6][i] = -sse_add(buf4[i], buf3[i]); break;
                    case 7: correct[7][i] = -sse_sub(buf3[i], buf3[i]); break;
#else
                    case 0: correct[0][i] = buf3[i] + buf4[i]; break;
                    case 1: correct[1][i] = buf3[i] - buf3[i]; break;
                    case 2: correct[2][i] = buf4[i] + buf3[i]; break;
                    case 3: correct[3][i] = buf3[i] - buf3[i]; break;
                    case 4: correct[4][i] = -(buf3[i] + buf4[i]); break;
                    case 5: correct[5][i] = -(buf3[i] - buf3[i]); break;
                    case 6: correct[6][i] = -(buf4[i] + buf3[i]); break;
                    case 7: correct[7][i] = -(buf3[i] - buf3[i]); break;
#endif
                }
                // Further skip test inputs if the device doesn support
                ...
                // zero in HW, it must be emulated in SW instead.
                if (gForceFTZ)
                {
                    if ((fabsf(correct[j][i]) < FLT_MIN)
                        && (correct[j][i] != 0.0f))
        ...
        if (gHasDouble)
        {
            ...
            if (NULL == buf3_double || NULL == buf4_double
                || NULL == buf5_double || NULL == buf6_double)
            {
                vlog_error("Out of memory initializing DP buffers\n");
                return TEST_FAIL;
            }
            for (i = 0; i < sizeof(correct_double) / sizeof(correct_double[0]);
                 i++)
            {
            ...
            if ((error =
                 clEnqueueWriteBuffer(gQueue, bufC_double, CL_FALSE, 0,
                                      BUFFER_SIZE, buf3_double, 0, NULL, NULL)))
            {
                vlog_error("Failure %d at clEnqueueWriteBuffer3\n", error);
                return TEST_FAIL;
            }
            if ((error =
                 clEnqueueWriteBuffer(gQueue, bufD_double, CL_FALSE, 0,
                                      BUFFER_SIZE, buf4_double, 0, NULL, NULL)))
            {
                vlog_error("Failure %d at clEnqueueWriteBuffer4\n", error);
                return TEST_FAIL;
            }
            ...
            double nan_val = nanf("");
            for (i = 0; i < BUFFER_SIZE / sizeof(double); i++) f5[i] = nan_val;
            ...
            for (i = 0; i < BUFFER_SIZE / sizeof(double); i++)
            {
                ...
                // turn that off
                correct_double[0][i] =
                sse_add_sd(buf3_double[i], buf4_double[i]);
                correct_double[1][i] =
                sse_sub_sd(buf3_double[i], buf3_double[i]);
                correct_double[2][i] =
                sse_add_sd(buf4_double[i], buf3_double[i]);
                correct_double[3][i] =
                sse_sub_sd(buf3_double[i], buf3_double[i]);
                correct_double[4][i] =
                -sse_add_sd(buf3_double[i], buf4_double[i]);
...
static int RunTest(int testNumber)
{
    ...
    {
        cl_kernel k =
        clCreateKernel(gProgram[vectorSize], kernelName[testNumber], &error);
        if (NULL == k || error)
        {
        ...
        if ((error = clEnqueueWriteBuffer(gQueue, bufE, CL_TRUE, 0, BUFFER_SIZE,
                                          buf5, 0, NULL, NULL)))
        {
        ...
        // execute the kernel
        size_t gDim[3] = { BUFFER_SIZE / (sizeof(cl_float) * (1 << vectorSize)),
                           0, 0 };
        if (((error = clEnqueueNDRangeKernel(gQueue, k, 1, NULL, gDim, NULL, 0,
                                             NULL, NULL))))
        {
        ...
        // read the data back
        if ((error = clEnqueueReadBuffer(gQueue, bufE, CL_TRUE, 0, BUFFER_SIZE,
                                         buf6, 0, NULL, NULL)))
        {
        ...
        for (i = 0; i < BUFFER_SIZE / sizeof(float); i++)
        {
            if (isnan(test[i]) && isnan(correct[testNumber][i])) continue;

            if (skipTest[testNumber][i]) continue;

            // sign of zero must be correct
            if ((((uint32_t *)test)[i] != ((uint32_t *)correct[testNumber])[i])
                && !(gIgnoreZeroSign && (test[i] == 0.0f)
                     && (correct[testNumber][i] == 0.0f)))
            {
                switch (testNumber)
                {
                    ...
                    case 0:
                        vlog_error(
                        "%ld) Error for %s %s: %a * %a + %a =  *%a vs. %a\n", i,
                        sizeNames[vectorSize], kernelName[testNumber], a[i],
                        b[i], c[i], correct[testNumber][i], test[i]);
                        clReleaseKernel(k);
                        return -1;
                    case 1:
                        vlog_error(
                    ...
                    case 2:
                        vlog_error(
                        "%ld) Error for %s %s: %a + %a * %a =  *%a vs. %a\n", i,
                        sizeNames[vectorSize], kernelName[testNumber], c[i],
                        a[i], b[i], correct[testNumber][i], test[i]);
                        clReleaseKernel(k);
                        return -1;
                    case 3:
                        vlog_error(
                    ...
                    case 4:
                        vlog_error(
                        "%ld) Error for %s %s: -(%a * %a + %a) =  *%a vs. %a\n",
                        i, sizeNames[vectorSize], kernelName[testNumber], a[i],
                        b[i], c[i], correct[testNumber][i], test[i]);
                        clReleaseKernel(k);
                        return -1;
                    case 5:
                    ...
                    case 6:
                        vlog_error(
                        "%ld) Error for %s %s: -(%a + %a * %a) =  *%a vs. %a\n",
                        i, sizeNames[vectorSize], kernelName[testNumber], c[i],
                        a[i], b[i], correct[testNumber][i], test[i]);
                        clReleaseKernel(k);
                        return -1;
                    case 7:
...
static int RunTest_Double(int testNumber)
{
    ...
    for (vectorSize = 0; vectorSize < 5; vectorSize++)
    {
        cl_kernel k = clCreateKernel(gProgram_double[vectorSize],
                                     kernelName[testNumber], &error);
        if (NULL == k || error)
        {
            vlog_error("%d) Unable to find kernel \"%s\" for vector size: %d\n",
                       error, kernelName[testNumber], 1 << vectorSize);
        ...
        // write NaNs to the result array
        if ((error =
             clEnqueueWriteBuffer(gQueue, bufE, CL_FALSE, 0, BUFFER_SIZE,
                                  buf5_double, 0, NULL, NULL)))
        {
            vlog_error("Failure %d at clWriteArray %d\n", error, testNumber);
            return error;
        }
        ...
        // execute the kernel
        size_t gDim[3] = {
            BUFFER_SIZE / (sizeof(cl_double) * (1 << vectorSize)), 0, 0
        };
        if (((error = clEnqueueNDRangeKernel(gQueue, k, 1, NULL, gDim, NULL, 0,
                                             NULL, NULL))))
        {
        ...
        for (i = 0; i < BUFFER_SIZE / sizeof(double); i++)
        {
            ...
            // sign of zero must be correct
            if (((uint64_t *)test)[i]
                != ((uint64_t *)correct_double[testNumber])[i])
            {
                switch (testNumber)
                {
                        // Zeros for these should be positive
                    case 0:
                        vlog_error(
                        "%ld) Error for %s %s: %a * %a + %a =  *%a vs. %a\n", i,
                        sizeNames_double[vectorSize], kernelName[testNumber],
                        a[i], b[i], c[i], correct[testNumber][i], test[i]);
                        return -1;
                    case 1:
                        vlog_error(
                        "%ld) Error for %s %s: %a * %a - %a =  *%a vs. %a\n", i,
                    ...
                    case 2:
                        ...
                        "%ld) Error for %s %s: %a + %a * %a =  *%a vs. %a\n", i,
                        sizeNames_double[vectorSize], kernelName[testNumber],
                        c[i], a[i], b[i], correct[testNumber][i], test[i]);
                        return -1;
                    case 3:
                        vlog_error(
                        "%ld) Error for %s %s: %a - %a * %a =  *%a vs. %a\n", i,
