...
const char *type_name[kTypeCount] = { "uchar", "char",  "ushort", "short",
                                      "uint",  "int",   "float",  "ulong",
                                      "long",  "double" };

const size_t type_size[kTypeCount] = { sizeof(cl_uchar),  sizeof(cl_char),
                                       sizeof(cl_ushort), sizeof(cl_short),
                                       sizeof(cl_uint),   sizeof(cl_int),
                                       sizeof(cl_float),  sizeof(cl_ulong),
                                       sizeof(cl_long),   sizeof(cl_double) };
...
void refselect_1i16u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_short *d, *x, *y;
...
void refselect_1u16u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_ushort *d, *x, *y, *m;
...
void refselect_1i32u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_int *d, *x, *y;
...
void refselect_1u32u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_uint *d, *x, *y, *m;
...
void refselect_1i64u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_long *d, *x, *y;
...
void refselect_1u64u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_ulong *d, *x, *y, *m;
...
void vrefselect_1i8(void *dest, void *src1, void *src2, void *cmp, size_t count)
{
    ...
    y = (cl_char *)src2;
    m = (cl_char *)cmp;
    for (i = 0; i < count; ++i) d[i] = (m[i] & 0x80) ? y[i] : x[i];
}
...
void vrefselect_1i16(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_short *d, *x, *y, *m;
...
void vrefselect_1u16(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_ushort *d, *x, *y;
...
void vrefselect_1i32(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_int *d, *x, *y, *m;
    ...
    y = (cl_int *)src2;
    m = (cl_int *)cmp;
    for (i = 0; i < count; ++i) d[i] = (m[i] & 0x80000000) ? y[i] : x[i];
}

void vrefselect_1u32(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_uint *d, *x, *y;
...
void vrefselect_1i64(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_long *d, *x, *y, *m;
...
void vrefselect_1u64(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_ulong *d, *x, *y;
...
void vrefselect_1i8u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_char *d, *x, *y;
    ...
    y = (cl_char *)src2;
    m = (cl_uchar *)cmp;
    for (i = 0; i < count; ++i) d[i] = (m[i] & 0x80U) ? y[i] : x[i];
}

void vrefselect_1u8u(void *dest, void *src1, void *src2, void *cmp,
                     size_t count)
{
    size_t i;
    cl_uchar *d, *x, *y, *m;
...
void vrefselect_1i16u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_short *d, *x, *y;
...
void vrefselect_1u16u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_ushort *d, *x, *y, *m;
...
void vrefselect_1i32u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_int *d, *x, *y;
    ...
    y = (cl_int *)src2;
    m = (cl_uint *)cmp;
    for (i = 0; i < count; ++i) d[i] = (m[i] & 0x80000000U) ? y[i] : x[i];
}

void vrefselect_1u32u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_uint *d, *x, *y, *m;
...
void vrefselect_1i64u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_long *d, *x, *y;
...
void vrefselect_1u64u(void *dest, void *src1, void *src2, void *cmp,
                      size_t count)
{
    size_t i;
    cl_ulong *d, *x, *y, *m;
...
size_t check_int(void *test, void *correct, size_t count, size_t vector_size)
{
    ...
    for (i = 0; i < count; i++)
        if (t[i] != c[i])
        {
            ...
            if (i)
            {
                log_error("\n(check_int) Error for vector size %ld found just "
                          "after 0x%8.8lx:  "
                          "*0x%8.8x vs 0x%8.8x\n",
...
size_t check_double(void *test, void *correct, size_t count, size_t vector_size)
{
    ...
    for (i = 0; i < count; i++) /* Allow nans to be binary different */
        if ((t[i] != c[i])
            && !(isnan(((double *)correct)[i]) && isnan(((double *)test)[i])))
        {
