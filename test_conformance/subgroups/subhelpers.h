                      ...
                      void *odata, size_t osize, size_t tsize = 0)
{
    ...
    error =
    clEnqueueWriteBuffer(queue, in, CL_FALSE, 0, isize, idata, 0, NULL, NULL);
    ...
    error =
    clEnqueueReadBuffer(queue, xy, CL_FALSE, 0, msize, mdata, 0, NULL, NULL);
    test_error(error, "clEnqueueReadBuffer failed");

    error =
    clEnqueueReadBuffer(queue, out, CL_FALSE, 0, osize, odata, 0, NULL, NULL);
    test_error(error, "clEnqueueReadBuffer failed");
