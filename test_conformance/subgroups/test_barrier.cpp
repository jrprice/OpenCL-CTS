...
"__kernel void test_lbar(const __global Type *in, __global int2 *xy, __global "
"Type *out)\n"
"{\n"
"    __local int tmp[200];\n"
...
"__kernel void test_gbar(const __global Type *in, __global int2 *xy, __global "
"Type *out, __global Type *tmp)\n"
"{\n"
"    int gid = get_global_id(0);\n"
"    int nid = get_sub_group_size();\n"
"    int lid = get_sub_group_local_id();\n"
