...
static const char *convert_image_type_to_string(cl_mem_object_type imageType)
{
    ...
    switch (imageType)
    {
        ...
        case CL_MEM_OBJECT_IMAGE1D_BUFFER: p = str_1d_image_buffer;
    }
    return p;
}
                   ...
                   cl_command_queue queue, cl_mem_object_type imageType)
{
    ...
    cl_mem_flags flags =
    (gTestReadWrite) ? CL_MEM_KERNEL_READ_AND_WRITE : CL_MEM_READ_ONLY;
    ...
    if (gTypesToTest & kTestFloat)
    {
        ...
        else
        {
            ...
            ret += test_read_image_formats(device, context, queue, formatList,
                                           filterFlags, numFormats,
                                           &imageSampler, kFloat, imageType);
        }
    }
