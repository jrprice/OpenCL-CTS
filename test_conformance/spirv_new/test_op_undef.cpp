...
TEST_SPIRV_FUNC(op_undef_struct_int_float_simple)
{
    ...
    return test_undef<CustomType>(deviceID, context, queue,
...
TEST_SPIRV_FUNC(op_undef_struct_struct_simple)
{
    ...
    return test_undef<CustomType2>(deviceID, context, queue,
...
TEST_SPIRV_FUNC(op_undef_half_simple)
{
    ...
    return test_undef<cl_float>(deviceID, context, queue, "undef_half_simple");
}
