...
template <typename T>
int test_ext_cl_khr_spirv_no_integer_wrap_decoration(
cl_device_id deviceID, cl_context context, cl_command_queue queue,
const char *spvName, const char *funcName, const char *Tname)
{
...
#define TEST_FMATH_FUNC(TYPE, FUNC)                                            \
    ...
    {                                                                          \
        return test_ext_cl_khr_spirv_no_integer_wrap_decoration<cl_##TYPE>(    \
        deviceID, context, queue,                                              \
        "ext_cl_khr_spirv_no_integer_wrap_decoration_" #FUNC "_" #TYPE, #FUNC, \
        #TYPE);                                                                \
    }
