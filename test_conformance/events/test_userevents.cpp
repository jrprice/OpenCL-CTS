                    ...
                    cl_command_queue queue, int num_elements)
{
    ...
    CL_EXIT_ERROR(
    (sizeof s == sizeofs) ? CL_SUCCESS : -1,
    "clGetEventInfo returned wrong size for CL_EVENT_COMMAND_EXECUTION_STATUS");
    ...
    cl_ulong p;
    err =
    clGetEventProfilingInfo(u1, CL_PROFILING_COMMAND_QUEUED, sizeof p, &p, 0);
    ...
    float buffer[1];
    cl_mem output =
    clCreateBuffer(context, CL_MEM_USE_HOST_PTR, sizeof buffer, buffer, &err);
    ...
    // ///////////////////////////////////////////////////////////////////
    {
        ...
        for (cl_uint i = 0; i != N; ++i)
        {
            ...
            "clGetEventInfo %u returned wrong status %d before user event", i,
            (int)s);
        }
