                                        ...
                                        size_t &outHeight)
{
    ...
    if (maxWidth * maxHeight * 4 > maxAllocSize / BufferSizeReductionFactor)
    {
        ...
        outHeight =
        (size_t)((maxAllocSize / (BufferSizeReductionFactor * 4)) / outWidth);
                                  ...
                                  cl_command_queue queue)
{
    ...
    mStreams[0] = clCreateBuffer(context, (cl_mem_flags)(CL_MEM_READ_WRITE),
                                 sizeof(cl_float) * 1000, NULL, &error);
    test_error(error, "Creating test array failed");
    mStreams[1] = clCreateBuffer(context, (cl_mem_flags)(CL_MEM_READ_WRITE),
                                    ...
                                    cl_event *waits, cl_event *outEvent)
{
    ...
    queue, mKernel, 1, NULL, threads, mLocalThreads, numWaits, waits, outEvent);
                                   ...
                                   cl_event *waits, cl_event *outEvent)
{
    ...
    cl_int error =
    clEnqueueWriteImage(queue, mImage, CL_FALSE, origin, region, 0, 0, mOutput,
                                          ...
                                          cl_event *outEvent)
{
    ...
    queue, mSrcImage, mDstBuffer, origin, region, 0, numWaits, waits, outEvent);
                                          ...
                                          cl_event *outEvent)
{
    ...
    queue, mSrcBuffer, mDstImage, 0, origin, region, numWaits, waits, outEvent);
