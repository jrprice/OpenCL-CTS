                 ...
                 cl_command_queue queue, int n_elems)
{
    ...
    {
        log_info(
        "Skipping double -- cl_khr_fp64 is not supported by this device.\n");
        return 0;
    }
...
"#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
"__kernel void test_degrees2_double(__global double2 *src, __global double2 "
"*dst)\n"
"{\n"
"    int  tid = get_global_id(0);\n"
"\n"
...
"#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
"__kernel void test_degrees4_double(__global double4 *src, __global double4 "
"*dst)\n"
"{\n"
"    int  tid = get_global_id(0);\n"
"\n"
...
"#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
"__kernel void test_degrees8_double(__global double8 *src, __global double8 "
"*dst)\n"
"{\n"
"    int  tid = get_global_id(0);\n"
"\n"
...
"#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
"__kernel void test_degrees16_double(__global double16 *src, __global double16 "
"*dst)\n"
"{\n"
"    int  tid = get_global_id(0);\n"
"\n"
