...
"#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
"__kernel void test_sign16_double(__global double16 *src, __global double16 "
"*dst)\n"
"{\n"
"    int  tid = get_global_id(0);\n"
"\n"
                     ...
                     cl_command_queue queue, int n_elems)
{
    ...
    create_single_kernel_helper(context, &program[5], &kernel[5], 1,
                                &sign3_kernel_code_double, "test_sign3_double");
    if (err) return -1;
