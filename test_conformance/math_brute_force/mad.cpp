...
int TestFunc_mad(const Func *f, MTdata d)
{
    ...
    BuildKernelInfo build_info = { gMinVectorSizeIndex, kernels, programs,
                                   f->nameInCode };
    if ((error =
         ThreadPool_Do(BuildKernel_FloatFn,
                       gMaxVectorSizeIndex - gMinVectorSizeIndex, &build_info)))
        return error;
    /*
...
*/
    ...
    for (i = 0; i < (1ULL << 32); i += step)
    {
        ...
        for (j = gMinVectorSizeIndex; j < gMaxVectorSizeIndex; j++)
        {
            ...
            if ((error =
                 clSetKernelArg(kernels[j], 1, sizeof(gInBuffer), &gInBuffer)))
            {
                LogBuildError(programs[j]);
                goto exit;
            }
 ...
 ); double correct3 = f->func.f_fff( -0.0, s2[j], s3[j] ); float err2 =
 Ulp_Error( test, correct2  ); float err3 = Ulp_Error( test, correct3  ); fail =
 fail && ((!(fabsf(err2) <= f->float_ulps)) && (!(fabsf(err3) <=
 f->float_ulps))); if( fabsf( err2 ) < fabsf(err ) ) err = err2; if( fabsf( err3
 ) < fabsf(err ) ) err = err3;

                            // retry per section 6.5.3.4
                            if( IsFloatResultSubnormal(correct2, f->float_ulps )
 || IsFloatResultSubnormal(correct3, f->float_ulps ) ) { // look at me now, fail
 = fail && ( test != 0.0f); if( ! fail ) err = 0.0f;
                            }
                            ...
                            { // its fun to have fun,
                                ...
                                double correct4 = f->func.f_fff( 0.0, -0.0,
 s3[j] ); double correct5 = f->func.f_fff( -0.0, -0.0, s3[j] ); err2 =
 Ulp_Error( test, correct2  ); err3 = Ulp_Error( test, correct3  ); float err4 =
 Ulp_Error( test, correct4  ); float err5 = Ulp_Error( test, correct5  ); fail =
 fail && ((!(fabsf(err2) <= f->float_ulps)) && (!(fabsf(err3) <= f->float_ulps))
 &&
                                                 (!(fabsf(err4) <=
 f->float_ulps)) && (!(fabsf(err5) <= f->float_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 fabsf( err4 ) < fabsf(err ) ) err = err4; if( fabsf( err5 ) < fabsf(err ) ) err
 = err5;
 ...
 ); double correct6 = f->func.f_fff( 0.0, 0.0, -0.0f ); double correct7 =
 f->func.f_fff( -0.0, 0.0, -0.0f ); double correct8 = f->func.f_fff( 0.0, -0.0,
 -0.0f ); double correct9 = f->func.f_fff( -0.0, -0.0, -0.0f ); err2 =
 Ulp_Error( test, correct2  ); err3 = Ulp_Error( test, correct3  ); err4 =
 Ulp_Error( test, correct4  ); err5 = Ulp_Error( test, correct5  ); float err6 =
 Ulp_Error( test, correct6  ); float err7 = Ulp_Error( test, correct7  ); float
 err8 = Ulp_Error( test, correct8  ); float err9 = Ulp_Error( test, correct9  );
                                    fail =  fail && ((!(fabsf(err2) <=
 f->float_ulps)) && (!(fabsf(err3) <= f->float_ulps)) &&
                                                     (!(fabsf(err4) <=
 ...
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 fabsf( err4 ) < fabsf(err ) ) err = err4; if( fabsf( err5 ) < fabsf(err ) ) err
 = err5; if( fabsf( err6 ) < fabsf(err ) ) err = err6; if( fabsf( err7 ) <
 fabsf(err ) ) err = err7; if( fabsf( err8 ) < fabsf(err ) ) err = err8; if(
 fabsf( err9 ) < fabsf(err ) ) err = err9;
 ...
 f->float_ulps ) || IsFloatResultSubnormal(correct3, f->float_ulps )  ||
                                        IsFloatResultSubnormal(correct4,
 f->float_ulps ) || IsFloatResultSubnormal(correct5, f->float_ulps )  ||
                                        IsFloatResultSubnormal( correct6,
 f->float_ulps ) || IsFloatResultSubnormal(correct7, f->float_ulps )  ||
                                        IsFloatResultSubnormal(correct8,
 f->float_ulps ) || IsFloatResultSubnormal( correct9, f->float_ulps )  )
                                    {
                                        fail = fail && ( test != 0.0f);
                                        if( ! fail )
                                            err = 0.0f;
                            ...
                            else if( IsFloatSubnormal( s3[j] ) )
                            {
                                ...
                                double correct4 = f->func.f_fff( 0.0,  s2[j],
 -0.0 ); double correct5 = f->func.f_fff( -0.0, s2[j], -0.0 ); err2 = Ulp_Error(
 test, correct2  ); err3 = Ulp_Error( test, correct3  ); float err4 = Ulp_Error(
 test, correct4  ); float err5 = Ulp_Error( test, correct5  ); fail =  fail &&
 ((!(fabsf(err2) <= f->float_ulps)) && (!(fabsf(err3) <= f->float_ulps)) &&
                                                 (!(fabsf(err4) <=
 f->float_ulps)) && (!(fabsf(err5) <= f->float_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 fabsf( err4 ) < fabsf(err ) ) err = err4; if( fabsf( err5 ) < fabsf(err ) ) err
 ...
 ); float err2 = Ulp_Error( test, correct2  ); float err3 = Ulp_Error( test,
 correct3  ); fail =  fail && ((!(fabsf(err2) <= f->float_ulps)) &&
 (!(fabsf(err3) <= f->float_ulps))); if( fabsf( err2 ) < fabsf(err ) ) err =
 err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3;

                            // retry per section 6.5.3.4
                            if( IsFloatResultSubnormal(correct2, f->float_ulps )
 || IsFloatResultSubnormal(correct3, f->float_ulps ) )
                            {
                                fail = fail && ( test != 0.0f);
                                if( ! fail )
                                    err = 0.0f;
 ...
 ); double correct5 = f->func.f_fff( s[j], -0.0, -0.0 ); err2 = Ulp_Error( test,
 correct2  ); err3 = Ulp_Error( test, correct3  ); float err4 = Ulp_Error( test,
 correct4  ); float err5 = Ulp_Error( test, correct5  ); fail =  fail &&
 ((!(fabsf(err2) <= f->float_ulps)) && (!(fabsf(err3) <= f->float_ulps)) &&
                                                 (!(fabsf(err4) <=
 f->float_ulps)) && (!(fabsf(err5) <= f->float_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 ...
 || IsFloatResultSubnormal(correct3, f->float_ulps ) )
                    ...
                    if( fail )
                    {
                        vlog_error( "\nERROR: %s%s: %f ulp error at {%a, %a,
 %a}: *%a vs. %a\n", f->name, sizeNames[k], err, s[j], s2[j], s3[j], ((float*)
 gOut_Ref)[j], test ); error = -1; goto exit;
                    }
                }
            }
        }
*/
    ...
    if (gMeasureTimes)
    {
        ...
        for (j = gMinVectorSizeIndex; j < gMaxVectorSizeIndex; j++)
        {
            ...
            * gComputeDevices * gSimdSize * 1e6 / (bufferSize / sizeof(float));
...
int TestFunc_mad_Double(const Func *f, MTdata d)
{
    ...
    BuildKernelInfo build_info = { gMinVectorSizeIndex, kernels, programs,
                                   f->nameInCode };
    if ((error =
         ThreadPool_Do(BuildKernel_DoubleFn,
                       gMaxVectorSizeIndex - gMinVectorSizeIndex, &build_info)))
    {
        return error;
    }
...
*/
            ...
            for( k = gMinVectorSizeIndex; k < gMaxVectorSizeIndex; k++ )
            {
                ...
                if( t[j] != q[j] )
                {
                    ...
                    if( fail && ftz )
                    {
                        ...
                        { // look at me,
                            long double correct2 = f->dfunc.f_fff( 0.0, s2[j],
 s3[j] ); long double correct3 = f->dfunc.f_fff( -0.0, s2[j], s3[j] ); float
 err2 = Bruteforce_Ulp_Error_Double( test, correct2  ); float err3 =
 Bruteforce_Ulp_Error_Double( test, correct3  ); fail =  fail && ((!(fabsf(err2)
 <= f->double_ulps)) && (!(fabsf(err3) <= f->double_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3;

                            // retry per section 6.5.3.4
                            if( IsDoubleResultSubnormal( correct2,
 f->double_ulps ) || IsDoubleResultSubnormal( correct3, f->double_ulps ) ) { //
 look at me now, fail = fail && ( test != 0.0f); if( ! fail ) err = 0.0f;
                            }
                            ...
                            { // its fun to have fun,
                                ...
                                long double correct4 = f->dfunc.f_fff( 0.0,
 -0.0, s3[j] ); long double correct5 = f->dfunc.f_fff( -0.0, -0.0, s3[j] ); err2
 ...
 Bruteforce_Ulp_Error_Double( test, correct5  ); fail =  fail && ((!(fabsf(err2)
 <= f->double_ulps)) && (!(fabsf(err3) <= f->double_ulps)) &&
                                                 (!(fabsf(err4) <=
 f->double_ulps)) && (!(fabsf(err5) <= f->double_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 fabsf( err4 ) < fabsf(err ) ) err = err4; if( fabsf( err5 ) < fabsf(err ) ) err
 = err5;
 ...
 f->double_ulps ) || IsDoubleResultSubnormal( correct5, f->double_ulps ) )
                                {
                                    fail = fail && ( test != 0.0f);
                                    if( ! fail )
                                        err = 0.0f;
 ...
 ); correct4 = f->dfunc.f_fff( 0.0, -0.0, 0.0f ); correct5 = f->dfunc.f_fff(
 -0.0, -0.0, 0.0f ); long double correct6 = f->dfunc.f_fff( 0.0, 0.0, -0.0f );
                                    long double correct7 = f->dfunc.f_fff( -0.0,
 0.0, -0.0f ); long double correct8 = f->dfunc.f_fff( 0.0, -0.0, -0.0f ); long
 double correct9 = f->dfunc.f_fff( -0.0, -0.0, -0.0f ); err2 =
 Bruteforce_Ulp_Error_Double( test, correct2  ); err3 =
 ...
 Bruteforce_Ulp_Error_Double( test, correct9  ); fail =  fail && ((!(fabsf(err2)
 <= f->double_ulps)) && (!(fabsf(err3) <= f->double_ulps)) &&
                                                     (!(fabsf(err4) <=
 ...
 f->double_ulps)) && (!(fabsf(err6) <= f->double_ulps)) &&
                                                     (!(fabsf(err7) <=
 f->double_ulps)) && (!(fabsf(err8) <= f->double_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3; if(
 fabsf( err4 ) < fabsf(err ) ) err = err4; if( fabsf( err5 ) < fabsf(err ) ) err
 = err5; if( fabsf( err6 ) < fabsf(err ) ) err = err6; if( fabsf( err7 ) <
 fabsf(err ) ) err = err7; if( fabsf( err8 ) < fabsf(err ) ) err = err8; if(
 ...
 f->double_ulps ) || IsDoubleResultSubnormal( correct7, f->double_ulps )  ||
                                        IsDoubleResultSubnormal( correct8,
 f->double_ulps ) || IsDoubleResultSubnormal( correct9, f->double_ulps )  )
                                    {
                                        fail = fail && ( test != 0.0f);
                                        if( ! fail )
                                            err = 0.0f;
                            ...
                            else if( IsDoubleSubnormal( s3[j] ) )
                            {
                                ...
                                long double correct4 = f->dfunc.f_fff( 0.0,
 s2[j], -0.0 ); long double correct5 = f->dfunc.f_fff( -0.0, s2[j], -0.0 ); err2
 = Bruteforce_Ulp_Error_Double( test, correct2  ); err3 =
 Bruteforce_Ulp_Error_Double( test, correct3  ); float err4 =
 Bruteforce_Ulp_Error_Double( test, correct4  ); float err5 =
 Bruteforce_Ulp_Error_Double( test, correct5  ); fail =  fail && ((!(fabsf(err2)
 ...
 f->double_ulps ) || IsDoubleResultSubnormal( correct5, f->double_ulps ) )
                        ...
                        {
                            long double correct2 = f->dfunc.f_fff( s[j], 0.0,
 s3[j] ); long double correct3 = f->dfunc.f_fff( s[j], -0.0, s3[j] ); float err2
 = Bruteforce_Ulp_Error_Double( test, correct2  ); float err3 =
 Bruteforce_Ulp_Error_Double( test, correct3  ); fail =  fail && ((!(fabsf(err2)
 <= f->double_ulps)) && (!(fabsf(err3) <= f->double_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3;
 ...
 f->double_ulps )  || IsDoubleResultSubnormal( correct3, f->double_ulps ) )
                            ...
                            if( IsDoubleSubnormal( s3[j] ) )
                            {
                                ...
                                long double correct4 = f->dfunc.f_fff( s[j],
 0.0, -0.0 ); long double correct5 = f->dfunc.f_fff( s[j], -0.0, -0.0 ); err2 =
 Bruteforce_Ulp_Error_Double( test, correct2  ); err3 =
 Bruteforce_Ulp_Error_Double( test, correct3  ); float err4 =
 Bruteforce_Ulp_Error_Double( test, correct4  ); float err5 =
 Bruteforce_Ulp_Error_Double( test, correct5  ); fail =  fail && ((!(fabsf(err2)
 ...
 f->double_ulps ) || IsDoubleResultSubnormal( correct5, f->double_ulps ) )
                        ...
                        {
                            long double correct2 = f->dfunc.f_fff( s[j], s2[j],
 0.0 ); long double correct3 = f->dfunc.f_fff( s[j], s2[j], -0.0 ); float err2 =
 Bruteforce_Ulp_Error_Double( test, correct2  ); float err3 =
 Bruteforce_Ulp_Error_Double( test, correct3  ); fail =  fail && ((!(fabsf(err2)
 <= f->double_ulps)) && (!(fabsf(err3) <= f->double_ulps))); if( fabsf( err2 ) <
 fabsf(err ) ) err = err2; if( fabsf( err3 ) < fabsf(err ) ) err = err3;
 ...
 f->double_ulps ) || IsDoubleResultSubnormal( correct3, f->double_ulps ) )
                    ...
                    if( fail )
                    {
                        vlog_error( "\nERROR: %sD%s: %f ulp error at {%a, %a,
 %a}: *%a vs. %a\n", f->name, sizeNames[k], err, s[j], s2[j], s3[j], ((double*)
 gOut_Ref)[j], test ); error = -1; goto exit;
                    }
                }
            }
...
*/
    ...
    if (gMeasureTimes)
    {
        ...
        for (j = gMinVectorSizeIndex; j < gMaxVectorSizeIndex; j++)
        {
            ...
            if (gReportAverageTimes) bestTime = sum / PERF_LOOP_COUNT;
            double clocksPerOp = bestTime * (double)gDeviceFrequency
            * gComputeDevices * gSimdSize * 1e6 / (bufferSize / sizeof(double));
