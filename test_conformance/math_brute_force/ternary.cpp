...
extern "C"
#endif
const vtbl _ternary = { "ternary", TestFunc_Float_Float_Float_Float,
                ...
                if (t[j] != q[j])
                {
                    ...
                    if (fail && ftz)
                    {
                        ...
                        else if (fail && IsFloatSubnormal(s2[j]))
                        {
                            ...
                            correct2 =
                            f->func.f_fma(s[j], 0.0f, s3[j], CORRECTLY_ROUNDED);
                            ...
                            if (0.0f == test
                                && (0.0f
                                    == f->func.f_fma(s[j], 0.0f, s3[j], FLUSHED)
                                    || 0.0f
                        ...
                        else if (fail && IsFloatSubnormal(s3[j]))
                        {
                            ...
                            correct2 =
                            f->func.f_fma(s[j], s2[j], 0.0f, CORRECTLY_ROUNDED);
                            ...
                            if (0.0f == test
                                && (0.0f
                                    == f->func.f_fma(s[j], s2[j], 0.0f, FLUSHED)
                                    || 0.0f
                        ...
                        { // look at me,
                            ...
                            { // its fun to have fun,
                                ...
                                { // but you have to know how!
                                    ...
                                    Bruteforce_Ulp_Error_Double(test, correct5);
                                    float err6 =
                                    Bruteforce_Ulp_Error_Double(test, correct6);
                                    float err7 =
                                    Bruteforce_Ulp_Error_Double(test, correct7);
                                    float err8 =
                                    Bruteforce_Ulp_Error_Double(test, correct8);
                                    float err9 =
                                    Bruteforce_Ulp_Error_Double(test, correct9);
                                    fail = fail
                                    && ((!(fabsf(err2) <= f->double_ulps))
                                        && (!(fabsf(err3) <= f->double_ulps))
                                        && (!(fabsf(err4) <= f->double_ulps))
                                        && (!(fabsf(err5) <= f->double_ulps))
                                        && (!(fabsf(err5) <= f->double_ulps))
                                        && (!(fabsf(err6) <= f->double_ulps))
                                        && (!(fabsf(err7) <= f->double_ulps))
                                        && (!(fabsf(err8) <= f->double_ulps)));
                                    if (fabsf(err2) < fabsf(err)) err = err2;
                                    if (fabsf(err3) < fabsf(err)) err = err3;
                                    if (fabsf(err4) < fabsf(err)) err = err4;
                                    if (fabsf(err5) < fabsf(err)) err = err5;
