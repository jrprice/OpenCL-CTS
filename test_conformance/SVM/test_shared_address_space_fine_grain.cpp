...
// fine-grain mode with no buffers. This is done by creating a linked list on a
...
// combination passes.
int test_svm_shared_address_space_fine_grain(cl_device_id deviceID,
                                             cl_context context2,
                                             ...
                                             int num_elements)
{
    ...
    &queues[0], &num_devices, CL_DEVICE_SVM_FINE_GRAIN_SYSTEM);
    if (error == 1)
               ...
               // on
    {
                   ...
                   // linked list on
        {
            ...
            else
            {
                ...
                vi, queues[vi], pNum_correct, kernel_verify_lists, ListLength,
                numLists);
                if (error) return -1;
            }
        }
