...
//
int test_svm_set_kernel_exec_info_svm_ptrs(cl_device_id deviceID,
                                           cl_context context2,
                                           ...
                                           int num_elements)
{
    ...
    bool failed = false;
    {
        ...
        test_error(error, "clCreateBuffer failed");
        bBuf =
        clCreateBuffer(c, CL_MEM_USE_HOST_PTR, sizeof(BufPtrs), pBuf, &error);
        test_error(error, "clCreateBuffer failed");
