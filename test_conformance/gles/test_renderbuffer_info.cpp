                              ...
                              cl_command_queue queue, int numElements)
{
    ...
    } formats[] = { { GL_RGBA8_OES, GL_UNSIGNED_BYTE, GL_RGBA, GL_UNSIGNED_BYTE,
                      kUChar },
             ...
             tgtIdx++)
        {
            ...
            for (i = 0; i < iter; i++)
            {
                ...
                if (test_renderbuffer_object_info(
                    ...
                    attachments[tgtIdx], formats[fmtIdx].rbFormat,
                    formats[fmtIdx].rbType, formats[fmtIdx].texFormat,
                    formats[fmtIdx].texType, formats[fmtIdx].type, seed))
                {
