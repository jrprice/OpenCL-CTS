...
"__kernel void test_pointer_cast(__global unsigned char *src, __global "
"unsigned int *dst)\n"
"{\n"
...
int verify_pointer_cast(unsigned char *inptr, unsigned int *outptr, int n)
{
...
int test_pointer_cast(cl_device_id device, cl_context context,
                      cl_command_queue queue, int num_elements)
{
    ...
    create_single_kernel_helper(context, &program, &kernel, 1,
                                &pointer_cast_kernel_code, "test_pointer_cast");
    if (err) return -1;
