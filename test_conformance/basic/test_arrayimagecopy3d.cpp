...
int test_arrayimagecopy3d_single_format(cl_device_id device, cl_context context,
                                        ...
                                        cl_image_format *format)
{
    ...
    if (err)
        log_error(
        "ARRAY to IMAGE3D copy test failed for image_channel_order=0x%lx and "
                          ...
                          cl_command_queue queue, int num_elements)
{
    ...
    {
        err |= test_arrayimagecopy3d_single_format(device, context, queue,
                                                   &formats[i]);
    }
