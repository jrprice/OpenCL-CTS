...
int verify_fpadd4(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
...
int verify_fpsub4(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
...
int verify_fpmul4(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
                       ...
                       cl_command_queue queue, int num_elements)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        {
            case 0:
                err = verify_fpadd4(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 4);
                break;
            case 1:
                err = verify_fpsub4(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 4);
                break;
            case 2:
                err = verify_fpmul4(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 4);
                break;
        }
