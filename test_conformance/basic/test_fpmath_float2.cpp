...
int verify_fpadd2(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
...
int verify_fpsub2(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
...
int verify_fpmul2(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
                       ...
                       cl_command_queue queue, int num_elements)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        {
            case 0:
                err = verify_fpadd2(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 2);
                break;
            case 1:
                err = verify_fpsub2(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 2);
                break;
            case 2:
                err = verify_fpmul2(input_ptr[0], input_ptr[1], output_ptr,
                                    num_elements * 2);
                break;
        }
