                                      ...
                                      cl_image_format *format)
{
    ...
    image = create_image_2d(context, (cl_mem_flags)(CL_MEM_READ_WRITE), format,
                        ...
                        cl_command_queue queue, int num_elements)
{
    ...
    context, CL_MEM_READ_WRITE, CL_MEM_OBJECT_IMAGE2D, 0, NULL, &num_formats);
    ...
    err = clGetSupportedImageFormats(context, CL_MEM_READ_WRITE,
                                     CL_MEM_OBJECT_IMAGE2D, num_formats,
                                     formats, NULL);
    test_error(err, "clGetSupportedImageFormats failed");
    ...
    {
        err |=
        test_imagearraycopy_single_format(device, context, queue, &formats[i]);
    }
