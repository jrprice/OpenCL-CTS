...
// max_delta, min1, max1
MATH_FUNCS_DEFINE_UNARY_FUNC(exponential, exp, std::exp, true, 3.0f, 4.0f,
                             0.001f, -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(exponential, expm1, std::expm1, true, 3.0f, 4.0f,
                             0.001f, -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(exponential, exp2, std::exp2, true, 3.0f, 4.0f,
                             0.001f, -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(exponential, exp10, reference::exp10, true, 3.0f,
                             4.0f, 0.001f, -1000.0f, 1000.0f)
...
struct exponential_func_ldexp : public binary_func<cl_float, cl_int, cl_float>
{
    ...
    cl_int min2() { return -8; }

    cl_int max2() { return 8; }
