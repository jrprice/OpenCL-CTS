...
// max_delta, min1, max1
MATH_FUNCS_DEFINE_UNARY_FUNC(other, erfc, std::erfc, true, 16.0f, 16.0f, 0.001f,
                             -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(other, erf, std::erf, true, 16.0f, 16.0f, 0.001f,
                             -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(other, fabs, std::fabs, true, 0.0f, 0.0f, 0.001f,
                             -1000.0f, 1000.0f)
MATH_FUNCS_DEFINE_UNARY_FUNC(other, tgamma, std::tgamma, true, 16.0f, 16.0f,
                             0.001f, -1000.0f, 1000.0f)

// group_name, func_name, reference_func, use_ulp, ulp, ulp_for_embedded,
// max_delta, min1, max1, min2, max2
MATH_FUNCS_DEFINE_BINARY_FUNC(other, hypot, std::hypot, true, 4.0f, 4.0f,
                              0.001f, -1000.0f, 1000.0f, -1000.0f, 1000.0f)

// group_name, func_name, reference_func, use_ulp, ulp, ulp_for_embedded,
// max_delta, min1, max1, min2, max2, min3, max3
MATH_FUNCS_DEFINE_TERNARY_FUNC(other, mad, reference::mad, false, 0.0f, 0.0f,
                               0.1f, -10.0f, 10.0f, -10.0f, 10.0f, -10.0f,
                               10.0f)
