...
struct int_func_mad24 : public ternary_func<IN1, IN2, IN3, OUT1>
{
    ...
    OUT1 operator()(const IN1& x, const IN2& y, const IN3& z)
    {
        ...
        static_assert(std::is_same<cl_uint, IN1>::value
                      || std::is_same<cl_int, IN1>::value,
    ...
    IN1 max1() { return (std::numeric_limits<IN1>::max)() & IN1(0x00FFFF); }

    IN2 min2() { return 0; }

    IN2 max2() { return (std::numeric_limits<IN2>::max)() & IN2(0x00FFFF); }
};

template <class IN1, class IN2, class OUT1>
struct int_func_mul24 : public binary_func<IN1, IN2, OUT1>
{
    std::string str() { return "mul24"; }
...
(cl_device_id device, cl_context context, cl_command_queue queue, int n_elems)
{
    ...
    (int_func_mad24<cl_uint, cl_uint, cl_uint, cl_uint>()))
