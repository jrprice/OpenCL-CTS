                           ...
                           cl_device_id rend_device)
{
    ...
    glFramebuffer, glRenderbuffer, GL_COLOR_ATTACHMENT0_EXT, GL_RGBA, GL_RGBA,
    GL_UNSIGNED_INT_8_8_8_8_REV, kUChar, framebufferSize, 128));
                    ...
                    cl_command_queue queue, int numElements)
{
    ...
    err =
    clGetContextInfo(context, CL_CONTEXT_DEVICES, device_cb, device_list, NULL);
    if (err != CL_SUCCESS)
    {
        free(device_list);
