                    ...
                    size_t size_to_allocate, cl_bool blocking_write)
{
    ...
    *mem =
    clCreateBuffer(context, CL_MEM_READ_WRITE, size_to_allocate, NULL, &error);
                          ...
                          size_t size_to_allocate, cl_bool blocking_write)
{
    ...
    error =
    find_good_image_size(device_id, size_to_allocate, &width, &height, NULL);
    ...
    *number_of_mems = 0;
           ...
           && current_allocation < max_to_allocate)
    {
        ...
        while (result == FAILED_TOO_BIG && allocation_this_time != 0)
        {
            ...
            // Create the object
            result =
            do_allocation(context, queue, device_id, allocation_this_time, type,
