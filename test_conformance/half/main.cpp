...
const char *addressSpaceNames[AS_NumAddressSpaces] = { "global", "private",
                                                       "local", "constant" };
...
test_definition test_list[] = {
    ADD_TEST(vload_half),      ADD_TEST(vloada_half),
    ADD_TEST(vstore_half),     ADD_TEST(vstorea_half),
    ADD_TEST(vstore_half_rte), ADD_TEST(vstorea_half_rte),
    ADD_TEST(vstore_half_rtz), ADD_TEST(vstorea_half_rtz),
    ADD_TEST(vstore_half_rtp), ADD_TEST(vstorea_half_rtp),
    ADD_TEST(vstore_half_rtn), ADD_TEST(vstorea_half_rtn),
    ADD_TEST(roundTrip),
};
...
int main(int argc, const char **argv)
{
    ...
    {
        g_arrVecSizes[i + kVectorSizeCount] = arrStrangeVecSizes[i];
    }
    ...
    if ((error = ParseArgs(argc, argv))) goto exit;
    ...
    fflush(stdout);
    error = runTestHarnessWithCheck(argCount, argList, test_num, test_list,
                                    true, 0, InitCL);
