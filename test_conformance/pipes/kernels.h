...
static const char* pipe_readwrite_struct_kernel_code = {
    ...
    "int    b;\n"
    "}TestStruct;\n"
    "__kernel void test_pipe_write_struct(__global TestStruct *src, "
    ...
    "}\n"
    "\n"
    "__kernel void test_pipe_read_struct(__read_only pipe TestStruct in_pipe, "
...
static const char* pipe_workgroup_readwrite_struct_kernel_code = {
    ...
    "int    b;\n"
    "}TestStruct;\n"
    "__kernel void test_pipe_workgroup_write_struct(__global TestStruct *src, "
    "__write_only pipe TestStruct out_pipe)\n"
    "{\n"
    "    int gid = get_global_id(0);\n"
    ...
    "}\n"
    "\n"
    "__kernel void test_pipe_workgroup_read_struct(__read_only pipe TestStruct "
    "in_pipe, __global TestStruct *dst)\n"
    "{\n"
    "    int gid = get_global_id(0);\n"
    "    __local reserve_id_t res_id; \n"
    "\n"
...
static const char* pipe_subgroup_readwrite_struct_kernel_code = {
    ...
    "__kernel void test_pipe_subgroup_write_struct(__global TestStruct *src, "
    "__write_only pipe TestStruct out_pipe)\n"
    "{\n"
    "    int gid = get_global_id(0);\n"
    "    reserve_id_t res_id; \n"
    ...
    "}\n"
    "\n"
    "__kernel void test_pipe_subgroup_read_struct(__read_only pipe TestStruct "
    "in_pipe, __global TestStruct *dst)\n"
    "{\n"
    "    int gid = get_global_id(0);\n"
    "    reserve_id_t res_id; \n"
...
static const char* pipe_convenience_readwrite_struct_kernel_code = {
    ...
    "int    b;\n"
    "}TestStruct;\n"
    "__kernel void test_pipe_convenience_write_struct(__global TestStruct "
    "*src, __write_only pipe TestStruct out_pipe)\n"
    "{\n"
    "    int gid = get_global_id(0);\n"
    "    write_pipe(out_pipe, &src[gid]);\n"
    "}\n"
    "\n"
    "__kernel void test_pipe_convenience_read_struct(__read_only pipe "
